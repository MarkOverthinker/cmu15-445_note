...
class LockManager {
  ...
  class LockRequestQueue {
   public:
    // if there is a entry of the txn ,retrun its place;if not, insert it and return its place
    std::list<LockRequest>::iterator Insert(txn_id_t txn_id, LockMode lock_mode) {
      ...
      request_queue_.emplace_back(LockRequest(txn_id, lock_mode));
